    ...
    >
      <View style={styles.sidebarContent}>
        ...
        <TouchableOpacity style={styles.sidebarItem}>
          ...
          <Text
            style={styles.sidebarItemText}
            onPress={() => navigation.navigate("agentproperty")}
          >
            Agent's Properties
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.sidebarItem}>
          <Icon name="help-circle-outline" size={20} color="#F4EBD0" />
          <Text
            style={styles.sidebarItemText}
            onPress={() => navigation.navigate("CustomField")}
          >
            Custom Fields
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.sidebarItem}
         onPress={() => navigation.navigate("Allqueries")}
        >
          <Icon name="pencil" size={20} color="#F4EBD0" />
          <Text style={styles.sidebarItemText}>All Queries</Text>
        </TouchableOpacity>
        <TouchableOpacity
