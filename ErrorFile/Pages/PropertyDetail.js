...
import { USER_ONE_PROPERTY, WISH_LIST } from '../Config/api';
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            try {
                ...
                setLiked(response.data.meta.property.whishlist);
            } catch (error) {
    ...
    const handleLikePress = async (id) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setLiked(response.data.data.whishlist);
            } else {
                setLiked(!newLikedStatus); // Revert the change if the update fails
            }
        } catch (error) {
            console.error('Error updating wishlist status:', error);
            setLiked(!newLikedStatus); // Revert the change on error
        }
    };
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.rightIconsContainer}>
                        <TouchableOpacity style={styles.iconButton} onPress={() => handleLikePress(property._id)}>
                            <Icon name="heart" size={23} style={[styles.icon, liked ? styles.likedIcon : styles.unlikedIcon]} />
                        </TouchableOpacity>
                    </View>
                </View>
                {selectedImage && (
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.contactButton} onPress={handleCallPress}>
                    <Icon name="phone" size={20} color="#fff" style={styles.contactIcon} />
                    <Text style={styles.contactText}>Call</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.contactButton} onPress={handleEmailPress}>
                    <Icon name="envelope" size={20} color="#fff" style={styles.contactIcon} />
                    <Text style={styles.contactText}>Email</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.contactButton} onPress={handleWhatsAppPress}>
                    <Icon name="whatsapp" size={20} color="#fff" style={styles.contactIcon} />
