...
import { GET_EMPLOYEE_QUERIES, ALL_EMPLOYEE_PROPERTY } from "../Config/api";
  ...
  useEffect(() => {
    const fetchLeadsLength = async () => {
      try {
        ...
        setLeadsLength(response.data.assignedQueries.length);
      } catch (error) {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        setPropertiesLength(response.data.meta.length); // Set the properties length
      } catch (err) {
        ...
        >
          <View style={styles.mainContent}>
            ...
            <TouchableOpacity style={styles.BigBox}>
              ...
              <Text style={styles.boxText1}>Total Property: {propertiesLength} </Text>
            ...
            <View style={styles.boxContainer}>
              ...
              <TouchableOpacity style={styles.box}>
                <Text style={styles.boxHead}>Assign Lead's</Text>
