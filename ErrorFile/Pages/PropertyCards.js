...
import { PROPERTY_GET, DELETE_PROPERTY } from "../Config/api";
...
const Properties = ({ navigation }) => {
  ...
  const fetchProperties = async () => {
    try {
        ...
        const approvedProperties = response.data.meta.properties.filter(property => property.adminApproval === "approved");
